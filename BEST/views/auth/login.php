...
<body>
    <div class="auth-container">
        <div class="auth-card fade-in">
            <a href="<?php echo APP_URL; ?>" class="back-link">← Back to Home</a>
    ...
    <script>
        ...
        loginForm.addEventListener('submit', async function(e) {
            ...
            try {
                const response = await fetch('<?php echo APP_URL; ?>controllers/AuthController.php?action=login', {
                    method: 'POST',
                    body: formData
                });
                ...
                if (data.success) {
                    ...
                    setTimeout(() => {
                        window.location.href = '<?php echo APP_URL; ?>' + data.redirect.replace(/^\//, '');
                    }, 1000);
                } else {
                ...
                showAlert('error', 'An error occurred. Please try again. Check console for details.');
                loginBtn.disabled = false;
                loginBtn.textContent = 'Login';
            }
        });
